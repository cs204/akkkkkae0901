...
знания0.добавить(new Эквивалентность(АЛжец, new Не(АРыцарь)))
// Добавьте
...
знания1.добавить(new Эквивалентность(БРыцарь, new Не(АРыцарь)))
...
знания3.добавить(new Эквивалентность(new И(АРыцарь, БРыцарь), АЛжец))
знания3.добавить(new Эквивалентность(АЛжец, new Не(АРыцарь)))
знания3.добавить(new Эквивалентность(БЛжец, new Не(АЛжец)))
знания3.добавить(new Эквивалентность(new И(АРыцарь, БЛжец), ВРыцарь))
знания3.добавить(new Эквивалентность(ВЛжец, new Не(БЛжец)))
